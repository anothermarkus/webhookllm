...
namespace GitLabWebhook.Tests
{
    public class GitLabWebhookTests
    {
        ...
        public async Task TestGitLabWebhookHandler_ValidPayload()
        {
            ...
            var result = await _controller.PostGitLabWebhook(webhookPayload);
